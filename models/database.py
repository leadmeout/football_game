...
class MongoDB():
    ...
    def write_teams_to_database(self, *args):
        # collection_teams, collection_match_days, collection_match_day_results = connect_to_db()

        document = {}
        self.collection_teams.replace_one(document, *args, True)

    def write_match_days_to_database(self, *args):
        # collection_teams, collection_match_days, collection_match_day_results = connect_to_db()
        ...
        document = {}
        self.collection_match_days.replace_one(document, *args, True)

    def write_match_day_results_to_database(self, *args):
        # collection_teams, collection_match_days, collection_match_day_results = connect_to_db()
        ...
        document = {}
        self.collection_match_day_results.replace_one(document, *args, True)
